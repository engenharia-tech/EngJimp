...
export const IssueReporter: React.FC<IssueReporterProps> = ({ onReport, currentUser }) => {
  ...
  if (currentUser.role !== 'GESTOR') {
    return (
      <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-md border border-gray-100 dark:border-slate-700 text-center">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input 
            ...
            className="w-full p-2 border border-gray-200 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-red-500 outline-none dark:bg-slate-900 dark:text-white"
        ...
        <div>
          ...
          <select 
            ...
            className="w-full p-2 border border-gray-200 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-red-500 outline-none bg-white dark:bg-slate-900 dark:text-white"
          >
