...
const STATUS_COLUMNS = [
  ...
  { id: GanttTaskStatus.IN_PROGRESS, label: 'EM DESENVOLVIMENTO', color: 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/30 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/30' },
